...
<Frame>
  <img height ="60%" src="/images/folders_create.png" />
</Frame>
...
<Frame>
  <img height ="60%" src="/images/folders_move_demo.png" />
</Frame>

4. Select the folder and click the `Move in` button.

<Frame>
  <img height ="60%" src="/images/folders_move_in.png" />
</Frame>
...
<Note> You can also create folders within folders to combine each of the three ways above based on your team needs.</Note>
