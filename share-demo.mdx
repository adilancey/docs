...
```
2. Add a class called `demo-id` along with the id of your demo to the button. You can find the `id` of your demo when you generated the direct link. Example: https://app.getlancey.com/demo/**d3459b64589646618221d5932185e60f**
